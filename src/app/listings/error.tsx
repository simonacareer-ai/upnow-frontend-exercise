    ...
    <main className="mx-auto flex max-w-lg flex-col items-center gap-4 px-6 py-20 text-center">
      ...
      <p className="text-sm text-neutral-500">
        {is429
          ...
          : "We couldn't load listings. The API may be temporarily unavailable."}
      </p>
      <button
        onClick={reset}
        className="mt-2 rounded-xl bg-primary px-5 py-2 text-sm font-medium text-white transition-colors hover:bg-primary-dark"
      >
        Try again
      </button>
    </main>
